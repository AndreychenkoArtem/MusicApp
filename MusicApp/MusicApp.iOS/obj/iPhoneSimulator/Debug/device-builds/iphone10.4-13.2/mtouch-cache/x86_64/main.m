...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("FlexiMvvm.Lifecycle.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("FlexiMvvm.Essentials.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	...
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("FlexiMvvm.Collections.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("FlexiMvvm.FullStack.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "MusicApp.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
